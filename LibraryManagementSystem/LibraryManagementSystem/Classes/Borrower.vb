...
Public Class Borrower
    Private Shared _borrowerId, _borrowerBarangayId, _borrowerCityId, _borrowerIdNew As String
    Private Shared _borrowerFirst, _borrowerMiddle, _borrowerLast, _borrowerGender, _borrowerPhone, _borrowerStreet, _borrowerType As String
    ...
    Public Sub addBorrower()
        ...
        sqlInsert = "INSERT INTO `borrower`(`borrowerId`, `borrowerFirst`, `borrowerMiddle`, `borrowerLast`, `borrowerGender`, `borrowerPhone`, `borrowerStreet`, `borrowerBarangayId`, `borrowerCityId`, `borrowerType`, `borrowerPhoto`) VALUES ('" & _
                                            BorrowerId + "','" & _
                                            BorrowerFirst + "','" & _
                                            BorrowerMiddle + "','" & _
                                            BorrowerLast + "','" & _
    ...
    Public Sub editBorrower()
        ...
        sqlUpdate = "UPDATE `borrower` SET " & _
            ...
            "',`borrowerBarangayId`='" + BorrowerBarangayId & _
            "',`borrowerCityId`='" + BorrowerCityId & _
