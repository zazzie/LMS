...
'                        "WHERE bookISBN LIKE '" & txtSearch.Text & "%' LIMIT 100;"
...
'                    "JOIN category ON categoryId=bookCategoryId " & _
'                    "JOIN publisher ON publisherId=bookPublisherId " & _
'                    "WHERE bookTitle LIKE '" & txtSearch.Text & "%' LIMIT 100;"
...
'                    "author.authorMiddle LIKE '" & txtSearch.Text & "%' LIMIT 100;"
...
'                    "JOIN category ON categoryId=bookCategoryId " & _
'                    "JOIN publisher ON publisherId=bookPublisherId " & _
'                    "WHERE category.categoryId = " & txtSearch.Text & " LIMIT 100;"
...
'                    "JOIN category ON categoryId=bookCategoryId " & _
'                    "JOIN publisher ON publisherId=bookPublisherId " & _
'                    "WHERE category.categoryName LIKE '" & txtSearch.Text & "%' LIMIT 100;"
...
'            "WHERE " & _
'            "libraryItemName LIKE '" & txtSearchItem.Text & "%' LIMIT 100;"
...
'            "libraryItemBorrowType LIKE '" & txtSearchItem.Text & "%' LIMIT 100;"
...
'                    "publisher.publisherName LIKE '" & txtSearch.Text & "%' LIMIT 100;"
...
'        If objFormAddBook.ShowDialog = Windows.Forms.DialogResult.OK Then
'            generateBookAll()
'        End If
'    End Sub
...
'            If objFormUpdateBook.ShowDialog = Windows.Forms.DialogResult.OK Then
'                generateBookAll()
'            End If
'        End If
'    End Sub
...
'        If objFormAddItem.ShowDialog = Windows.Forms.DialogResult.OK Then
'            generateItemAll()
'        End If
'    End Sub
...
'            If objFormUpdateItem.ShowDialog = Windows.Forms.DialogResult.OK Then
'                generateItemAll()
'            End If
'        End If
'    End Sub
