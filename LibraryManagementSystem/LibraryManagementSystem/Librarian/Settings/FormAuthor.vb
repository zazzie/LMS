Public Class FormAuthor
    ...
    Private Sub btnAddAuthor_Click(sender As Object, e As EventArgs) Handles btnAddAuthor.Click
        ...
        txtAuthorId.Text = generateId("author", "authorId", "AU")
        ...
        If btnEditAuthor.Text = "Save" Then
            If Not String.IsNullOrWhiteSpace(txtAuthorFirst.Text) Then
                If Not String.IsNullOrWhiteSpace(txtAuthorLast.Text) Then
                    If dgvAuthor.Rows.Count > 0 Then
                        If countRecord("SELECT COUNT(*) FROM author WHERE authorFirst='" + txtAuthorFirst.Text + "' AND authorMiddle='" + txtAuthorMiddle.Text + "' AND authorLast='" + txtAuthorLast.Text + "';") = 0 Then
                            addNewAuthor()
    ...
    Private Sub txtAuthorId_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtAuthorId.KeyPress
        Dim c As Char
        c = e.KeyChar
    ...
    Private Sub txtAuthorId_LostFocus(sender As Object, e As EventArgs) Handles txtAuthorId.LostFocus
        txtAuthorId.Text = txtAuthorId.Text.ToUpper
    End Sub

    Private Sub txtAuthorId_TextChanged(sender As Object, e As EventArgs) Handles txtAuthorId.TextChanged
