Public Class FormMain
    ...
    Private Sub pnlUp_DoubleClick1(sender As Object, e As EventArgs) Handles pnlUp.DoubleClick
        loadMissionVision()
    End Sub

    Private Sub pnlUp_Paint(sender As Object, e As PaintEventArgs) Handles pnlUp.Paint
